    ...
    <div class="front-card__info">
      ...
      <div class="front-card__detail">
        ...
        <div class="info-detail-box">
          <TaskCard v-if="cardViewClass" v-for="item in list" :type="item.type" :description="item.description" />
        </div>
      </div>
    </div>
    <div class="front-card__users">
      <h3 class="description">アサイン's</h3>
      <InfoUser v-for="user in userData" :userInfo="user" :detail="cardViewClass"  />
    </div>
  </div>
</div>
</template>
